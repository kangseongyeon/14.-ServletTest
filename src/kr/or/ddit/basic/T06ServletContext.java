...
public class T06ServletContext extends HttpServlet{
/*
 *  서블릿 컨텍스트 객체에 대하여...
 *  
 *  1. 서블릿 프로그램이 컨테이너와 정보를 주고받기 위한 메서드를 제공한다.
 *  ex) 파일 MIME TYPE정보 가져오기, 요청정 보내기, 로깅처리 등
 *  
 ...
 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("배포기술자에 기술된 컨텍스트명 : " + ctx.getServletContextName()); //web.xml -> <display-name>ServletTest</display-name> -> 배포기술자명
